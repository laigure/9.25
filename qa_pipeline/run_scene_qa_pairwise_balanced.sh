...
SOURCE_QA=$DATA/scene_reasoning_qa_v3_balanced_categories
TOKENS=$DATA/scene_multi_balanced_tokens
QA_OUT=$DATA/scene_qa_v3_balanced_tokens
RUNS=$DATA/runs
PROJECTOR_OUT=$RUNS/scene_qa_v3_pairwise_projector
LORA_OUT=$RUNS/scene_qa_v3_pairwise_lora
SHUFFLED_OUT=$RUNS/scene_qa_v3_pairwise_shuffled
STAGE=$DATA/scene_qa_v3_pairwise_status
